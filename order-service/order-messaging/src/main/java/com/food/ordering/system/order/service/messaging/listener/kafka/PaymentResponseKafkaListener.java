...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
	...
	public void receive(@Payload List<PaymentResponseAvroModel> messages,
		...
		messages.forEach(message -> {
			PaymentResponse response = orderMessagingDataMapper.paymentResponseAvroModelToPaymentResponse(message);
			if (PaymentStatus.COMPLETED == message.getPaymentStatus()) {
				...
				paymentResponseMessageListener.paymentCancelled(response);
			}
		});
	}
